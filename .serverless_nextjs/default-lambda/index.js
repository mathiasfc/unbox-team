...
const buildS3RetryStrategy = async () => {
    const { defaultRetryDecider, StandardRetryStrategy } = await Promise.resolve().then(function () { return index$1; });
...
const handleOriginResponse = async ({ event, manifest, prerenderManifest }) => {
    ...
    if (isDataRequest(uri) &&
        ...
        const getStream = await Promise.resolve().then(function () { return index$2; });
        let bodyString;
        const s3Params = {
            Bucket: bucketName,
            Key: s3Key
...
var index$2 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), getStream_1, {
  'default': getStream_1,
  buffer: buffer,
  array: array,
